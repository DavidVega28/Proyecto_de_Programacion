...
public class enviar_Correo {
    ...
    static final String BODY = "Estimado usuario, bienvenido al sistema de la Universidad LD."
            + ""
            ...
            + "El sector administrativo de la Universidad LD no le pedirá su información de inicio de sesión por ningún motivo."
            + ""
            + "Se despide, sector administrativo de la Universidad LD."
            + ""
            + "Universidad LD."
            + "Forjando a los mejores profesionales del país.";
